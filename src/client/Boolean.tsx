...
export default class Boolean extends React.Component <IndexProps, {}>{
    ...
    render() {
        return (
                ...
                <input type="radio" name={this.props.data.id} value={this.props.data.answers[0]} />True<br />
                <input type="radio" name={this.props.data.id} value={this.props.data.answers[1]} />False<br />
